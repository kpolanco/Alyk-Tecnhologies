package com.openweather.consumer.mongodb;
...
public class WeatherConsumerMongoDbwsApplication {

	public static void main(String[] args) {
		SpringApplication.run(WeatherConsumerMongoDbwsApplication.class, args);
	}
}